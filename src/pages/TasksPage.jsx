...
const TasksPage = () => {
  ...
  const [tasks, setTasks] = useState([
    { title: 'Go to the gym', deadline: '12:00', color: '#0071FF' },
    { title: 'Finish presentation slides', deadline: '17:00', color: '#ff2200' },
    { title: 'Jogging', deadline: '19:00', color: '#ffd900' },
    { title: 'Read one chapter', deadline: '21:00', color: '#00ffa2' }
  ])
